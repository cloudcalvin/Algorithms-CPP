...
/************************************************************************
Program for sorting and searching the record using STL
/************************************************************************/
#include <iostream.h>
#include <iomanip.h>
#include<string.h>
...
node temp;
list<node> lst; // create an empty list
...
void Display()
{
    ...
    cout<<"\n----------------------------------------------------------------";
    cout<<"\n Item Code          Item Name           Qunatity    Cost";
    cout<<"\n----------------------------------------------------------------";
    for(ptr=lst.begin(); ptr!=lst.end(); ptr++) //accessing the contents thru iterator
        {
            cout<<"\n";
            cout<<"      "<<(*ptr).item_code;
            cout<<"               "<<(*ptr).item_name;
